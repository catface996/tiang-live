import{u as E,c as H,j as e,d as h}from"./index-DWPu_TRF.js";import{M as ee,a9 as x,d as v,C as n,af as se,l as P,aQ as me,a7 as ue,x as d,t as f,j as u,a_ as te,T as ae,a$ as V,B as C,b0 as he,i as O,r as m,Y as z,n as xe,o as ge,S as D,a as je,ap as be,u as G,v as ye,w as ve,ai as q,k as $e,ak as ke,al as we,g as De,aw as Ce}from"./antd-DnS9M1TX.js";import{s as Ie}from"./index-Daowydkz.js";import{S as Se}from"./SearchFilterBar-CUZKkW-k.js";import"./vendor-DJG_os-6.js";const{Option:p}=P,{TextArea:W}=se,Te=h(ue)`
  margin-top: 16px;
...
`,Re=({visible:s,editingPrompt:r,form:I,onOk:S,onCancel:j})=>{const{t:a}=E(["prompts","common"]),{currentTheme:$}=H(b=>b.theme),i=$==="dark";return e.jsx(ee,{title:a(r?"prompts:editTemplate":"prompts:createTemplate"),open:s,onOk:S,onCancel:j,width:800,destroyOnClose:!0,children:e.jsxs(x,{form:I,layout:"vertical",initialValues:{language:"zh-CN",difficulty:"intermediate",isPublic:!1},children:[e.jsxs(v,{gutter:16,children:[e.jsx(n,{span:12,children:e.jsx(x.Item,{name:"name",label:a("prompts:form.templateName"),rules:[{required:!0,message:a("prompts:form.templateNameRequired")}],children:e.jsx(se,{placeholder:a("prompts:form.templateNamePlaceholder")})})}),e.jsx(n,{span:12,children:e.jsx(x.Item,{name:"category",label:a("prompts:form.category"),rules:[{required:!0,message:a("prompts:form.categoryRequired")}],children:e.jsxs(P,{placeholder:a("prompts:form.categoryPlaceholder"),children:[e.jsx(p,{value:"开发工具",children:a("prompts:categories.devTools")}),e.jsx(p,{value:"运维工具",children:a("prompts:categories.opsTools")}),e.jsx(p,{value:"产品管理",children:a("prompts:categories.productManagement")}),e.jsx(p,{value:"文档工具",children:a("prompts:categories.docTools")}),e.jsx(p,{value:"客服助手",children:a("prompts:categories.customerService")}),e.jsx(p,{value:"数据分析",children:a("prompts:categories.dataAnalysis")})]})})})]}),e.jsx(x.Item,{name:"description",label:a("prompts:form.description"),rules:[{required:!0,message:a("prompts:form.descriptionRequired")}],children:e.jsx(W,{rows:2,placeholder:a("prompts:form.descriptionPlaceholder")})}),e.jsx(x.Item,{name:"content",label:a("prompts:form.content"),rules:[{required:!0,message:a("prompts:form.contentRequired")}],children:e.jsx(W,{rows:8,placeholder:a("prompts:form.contentPlaceholder")})}),e.jsxs(v,{gutter:16,children:[e.jsx(n,{span:8,children:e.jsx(x.Item,{name:"language",label:a("prompts:form.language"),rules:[{required:!0,message:a("prompts:form.languageRequired")}],children:e.jsxs(P,{placeholder:a("prompts:form.languagePlaceholder"),children:[e.jsx(p,{value:"zh-CN",children:"中文"}),e.jsx(p,{value:"en-US",children:"English"}),e.jsx(p,{value:"ja-JP",children:"日本語"})]})})}),e.jsx(n,{span:8,children:e.jsx(x.Item,{name:"difficulty",label:a("prompts:form.difficulty"),rules:[{required:!0,message:a("prompts:form.difficultyRequired")}],children:e.jsxs(P,{placeholder:a("prompts:search.difficulty"),children:[e.jsx(p,{value:"beginner",children:a("prompts:difficulty.beginner")}),e.jsx(p,{value:"intermediate",children:a("prompts:difficulty.intermediate")}),e.jsx(p,{value:"advanced",children:a("prompts:difficulty.advanced")})]})})}),e.jsx(n,{span:8,children:e.jsx(x.Item,{name:"isPublic",label:a("prompts:detail.isPublic"),valuePropName:"checked",children:e.jsx(me,{})})})]}),e.jsx(Te,{$isDark:i,message:a("prompts:form.variableTip"),description:a("prompts:form.variableTipDescription"),type:"info",showIcon:!0})]})})},{Text:X}=ae,Me=h(ee)`
  .ant-modal-content {
...
`;h.div`
  ...
  border-radius: 6px;
  margin-bottom: 16px;
`;const Le=()=>{const{t:s}=E(["prompts","common"]),{currentTheme:r}=H(t=>t.theme),[I,S]=m.useState(!1),[j,a]=m.useState(!1),[$,i]=m.useState(!1),[b,l]=m.useState(null),[F,T]=m.useState(null),[R,M]=m.useState(""),[c,k]=m.useState("all"),[L,N]=m.useState("all"),[A,re]=m.useState("all"),[w]=x.useForm();m.useEffect(()=>{Ie(s("prompts:title"))},[s]);const g=[{id:"1",name:"代码审查助手",category:"开发工具",description:"帮助开发者进行代码审查，识别潜在问题和改进建议",content:`你是一个专业的代码审查专家。请仔细审查以下代码，并提供详细的反馈：
...
请确保文档结构清晰，内容详实，易于理解。`,variables:["project_name","module_name","tech_stack","api_details","use_cases"],tags:["技术文档","文档生成","API文档"],language:"zh-CN",difficulty:"beginner",rating:4.4,usageCount:423,isPublic:!1,isFavorite:!1,createdBy:"技术团队",createdAt:"2024-06-05",lastModified:"2024-06-13",lastUsed:"2024-06-15 11:15:00",version:"1.0"}],K={开发工具:{color:"blue",icon:e.jsx(Ce,{})},运维工具:{color:"green",icon:e.jsx(De,{})},产品管理:{color:"orange",icon:e.jsx(we,{})},文档工具:{color:"purple",icon:e.jsx(z,{})},客服助手:{color:"cyan",icon:e.jsx(ke,{})},数据分析:{color:"red",icon:e.jsx($e,{})}},Y={beginner:{name:"初级",color:"green"},intermediate:{name:"中级",color:"orange"},advanced:{name:"高级",color:"red"}},J=t=>({开发工具:"devTools",运维工具:"opsTools",产品管理:"productManagement",文档工具:"docTools",客服助手:"customerService",数据分析:"dataAnalysis"})[t]||"devTools",ie=()=>{l(null),w.resetFields(),a(!0)},le=t=>{l(t),w.setFieldsValue({name:t.name,category:t.category,description:t.description,content:t.content,language:t.language,difficulty:t.difficulty,isPublic:t.isPublic}),a(!0)},Q=t=>{T(t),i(!0)},oe=t=>{navigator.clipboard.writeText(t.content),q.success(s("prompts:messages.copySuccess"))},ne=async()=>{try{const t=await w.validateFields();b?q.success(s("prompts:messages.updateSuccess")):q.success(s("prompts:messages.createSuccess")),a(!1),w.resetFields()}catch(t){console.error("表单验证失败:",t)}},ce=()=>g.map(t=>{const o=K[t.category],B=Y[t.difficulty];return e.jsx(n,{xs:24,sm:24,md:12,lg:8,xl:8,children:e.jsxs(ze,{title:e.jsxs("div",{className:"card-title",children:[e.jsx("div",{className:"title-left",children:e.jsxs(u,{children:[o==null?void 0:o.icon,e.jsx("span",{children:t.name})]})}),e.jsx("div",{className:"title-right",children:t.isFavorite&&e.jsx(V,{})})]}),onClick:()=>Q(t),children:[e.jsx("div",{style:{marginBottom:12},children:e.jsxs(u,{wrap:!0,children:[e.jsx(f,{color:o==null?void 0:o.color,icon:o==null?void 0:o.icon,children:s(`prompts:categories.${J(t.category)}`)}),e.jsx(f,{color:B==null?void 0:B.color,children:s(`prompts:difficulty.${t.difficulty}`)}),t.isPublic&&e.jsx(f,{color:"blue",children:s("prompts:status.public")})]})}),e.jsx(Z,{ellipsis:{rows:2},style:{marginBottom:16,minHeight:40},children:t.description}),e.jsx("div",{style:{marginBottom:12},children:e.jsxs(v,{gutter:16,children:[e.jsx(n,{span:12,children:e.jsxs("div",{style:{textAlign:"center"},children:[e.jsx(te,{disabled:!0,value:t.rating,allowHalf:!0}),e.jsx("div",{children:t.rating})]})}),e.jsx(n,{span:12,children:e.jsx(D,{title:s("prompts:stats.usageCount"),value:t.usageCount})})]})}),e.jsx("div",{style:{marginBottom:12},children:e.jsxs(u,{wrap:!0,children:[t.tags.slice(0,3).map(y=>e.jsx(f,{size:"small",children:y},y)),t.tags.length>3&&e.jsxs(f,{size:"small",children:["+",t.tags.length-3]})]})}),e.jsxs("div",{style:{fontSize:12,color:"#666"},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"4px"},children:[e.jsxs("span",{children:[s("prompts:detail.version"),":"]}),e.jsx("span",{children:t.version})]}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e.jsxs("span",{children:[s("prompts:detail.lastUsed"),":"]}),e.jsx("span",{children:t.lastUsed})]})]}),e.jsx("div",{className:"card-actions",children:e.jsxs(u,{children:[e.jsx(G,{title:s("prompts:actions.view"),children:e.jsx(C,{type:"text",icon:e.jsx(ye,{}),size:"small",onClick:y=>{y.stopPropagation(),Q(t)}})}),e.jsx(G,{title:s("prompts:actions.edit"),children:e.jsx(C,{type:"text",icon:e.jsx(ve,{}),size:"small",onClick:y=>{y.stopPropagation(),le(t)}})})]})})]})},t.id)}),de=g.filter(t=>t.isPublic).length,pe=g.filter(t=>t.isFavorite).length;g.reduce((t,o)=>t+o.usageCount,0);const fe=g.reduce((t,o)=>t+o.rating,0)/g.length;return e.jsxs(Ae,{className:"prompt-templates-page",children:[e.jsxs(Be,{children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8},children:[e.jsx(Ne,{level:2,style:{margin:0},children:e.jsxs(u,{children:[e.jsx(z,{}),s("prompts:title")]})}),e.jsxs(u,{children:[e.jsx(C,{icon:e.jsx(xe,{}),children:s("common:refresh")}),e.jsx(C,{type:"primary",icon:e.jsx(ge,{}),onClick:ie,children:s("prompts:createPrompt")})]})]}),e.jsx(Z,{style:{marginTop:0,marginBottom:0},children:s("prompts:subtitle")})]}),e.jsxs(v,{gutter:16,style:{marginBottom:24},children:[e.jsx(n,{xs:24,sm:12,md:6,children:e.jsx(_,{className:"prompt-stats-primary",children:e.jsx(D,{title:s("prompts:stats.totalTemplates"),value:g.length,prefix:e.jsx(z,{})})})}),e.jsx(n,{xs:24,sm:12,md:6,children:e.jsx(_,{className:"prompt-stats-success",children:e.jsx(D,{title:s("prompts:stats.publicTemplates"),value:de,prefix:e.jsx(je,{})})})}),e.jsx(n,{xs:24,sm:12,md:6,children:e.jsx(_,{className:"prompt-stats-warning",children:e.jsx(D,{title:s("prompts:stats.favoriteTemplates"),value:pe,prefix:e.jsx(V,{})})})}),e.jsx(n,{xs:24,sm:12,md:6,children:e.jsx(_,{className:"prompt-stats-purple",children:e.jsx(D,{title:s("prompts:stats.averageRating"),value:fe.toFixed(1),prefix:e.jsx(be,{})})})})]}),e.jsx(Se,{searchValue:R,onSearchChange:M,searchPlaceholder:s("prompts:search.placeholder"),filters:[{key:"category",value:c,onChange:k,placeholder:s("prompts:search.category"),width:120,options:[{value:"all",label:s("prompts:search.allCategories")},{value:"开发工具",label:s("prompts:categories.devTools")},{value:"运维工具",label:s("prompts:categories.opsTools")},{value:"产品管理",label:s("prompts:categories.productManagement")},{value:"文档工具",label:s("prompts:categories.docTools")},{value:"客服助手",label:s("prompts:categories.customerService")},{value:"数据分析",label:s("prompts:categories.dataAnalysis")}]},{key:"difficulty",value:L,onChange:N,placeholder:s("prompts:search.difficulty"),width:100,options:[{value:"all",label:s("prompts:search.allDifficulties")},{value:"beginner",label:s("prompts:difficulty.beginner")},{value:"intermediate",label:s("prompts:difficulty.intermediate")},{value:"advanced",label:s("prompts:difficulty.advanced")}]},{key:"status",value:A,onChange:re,placeholder:s("prompts:search.status"),width:100,options:[{value:"all",label:s("prompts:search.allStatuses")},{value:"public",label:s("prompts:status.public")},{value:"private",label:s("prompts:status.private")},{value:"favorite",label:s("prompts:status.favorite")}]}],onRefresh:()=>window.location.reload()}),e.jsx(v,{gutter:[16,16],children:ce()}),e.jsx(Re,{visible:j,editingPrompt:b,form:w,onOk:ne,onCancel:()=>a(!1)}),e.jsx(Fe,{visible:$,selectedPrompt:F,onCancel:()=>i(!1),onCopyPrompt:oe,categoryMap:K,difficultyMap:Y,getCategoryKey:J})]})};export{Le as default};
