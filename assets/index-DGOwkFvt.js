import{u as S,j as e,d as h,c as U,b as ee,e as se,s as F,f as te,h as M,i as ne,k as ae,l as re}from"./index-Ds4hQBUW.js";import{t as L,u as v,a as A,V as T,b0 as V,aA as ie,T as z,an as le,j as D,B as P,v as oe,w as de,o as X,Q as ce,i as R,b1 as q,a4 as pe,X as xe,ao as _,e as fe,ae as J,d as Z,C as K,S as he,aj as me,a8 as ge,r as ue,ai as B,n as ye}from"./antd-Beg1odhe.js";import{s as je}from"./index-Daowydkz.js";import{g as ve,a as w,b as be,p as H}from"./PlaneCreateEdit-6GNPFlMY.js";import{P as ns}from"./PlaneCreateEdit-6GNPFlMY.js";import"./vendor-DJG_os-6.js";const Q=h.div`
  display: flex;
  align-items: center;
...
`,$e=h.div`
  width: 100%;
  margin-top: 8px;
`,ke=({entityHealth:s,showProgress:o=!1,size:t="default"})=>{const{t:r}=S(["entities","common"]),{healthy:n,warning:f,error:l,total:i}=s;if(i===0)return e.jsx(Q,{$size:t,children:e.jsx(L,{color:"default",children:r("planes:card.entityStats.noEntities")})});const x=n/i*100,m=f/i*100,g=l/i*100;return e.jsxs("div",{children:[e.jsxs(Q,{$size:t,children:[e.jsx(v,{title:`${r("planes:card.entityStats.healthyTooltip")}: ${n} (${x.toFixed(1)}%)`,children:e.jsxs(W,{$size:t,children:[e.jsx(A,{style:{color:"#52c41a"}}),e.jsx("span",{style:{color:"#52c41a",fontWeight:500},children:n})]})}),e.jsx(v,{title:`${r("planes:card.entityStats.warningTooltip")}: ${f} (${m.toFixed(1)}%)`,children:e.jsxs(W,{$size:t,children:[e.jsx(T,{style:{color:"#faad14"}}),e.jsx("span",{style:{color:"#faad14",fontWeight:500},children:f})]})}),e.jsx(v,{title:`${r("planes:card.entityStats.errorTooltip")}: ${l} (${g.toFixed(1)}%)`,children:e.jsxs(W,{$size:t,children:[e.jsx(V,{style:{color:"#ff4d4f"}}),e.jsx("span",{style:{color:"#ff4d4f",fontWeight:500},children:l})]})}),e.jsxs("span",{style:{color:"#8c8c8c",fontSize:t==="small"?"11px":"12px"},children:["/ ",i]})]}),o&&e.jsxs($e,{children:[e.jsx(ie,{percent:100,success:{percent:x},strokeColor:{"0%":"#ff4d4f",[`${g}%`]:"#ff4d4f",[`${g+m}%`]:"#faad14","100%":"#52c41a"},showInfo:!1,size:"small"}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",fontSize:"11px",color:"#8c8c8c",marginTop:"4px"},children:[e.jsxs("span",{children:[r("planes:card.entityStats.error")," ",g.toFixed(1),"%"]}),e.jsxs("span",{children:[r("planes:card.entityStats.warning")," ",m.toFixed(1),"%"]}),e.jsxs("span",{children:[r("planes:card.entityStats.healthy")," ",x.toFixed(1),"%"]})]})]})]})},{Text:$,Paragraph:we}=z,De=h(R)`
  margin-bottom: 16px;
...
`,Fe=({planes:s,relationships:o,loading:t=!1,onPlaneAction:r})=>{const{t:n}=S(["planes","common"]),f=[...s].sort((i,x)=>x.level-i.level),l=i=>f.some(x=>x.level===i-1);return t?e.jsx(O,{children:e.jsxs("div",{className:"loading-container",children:[e.jsx(xe,{size:"large"}),e.jsx("div",{className:"loading-text",children:n("planes:loading.topology")})]})}):s.length===0?e.jsx(O,{children:e.jsx(_,{description:n("planes:loading.noPlaneData"),image:_.PRESENTED_IMAGE_SIMPLE})}):e.jsx(O,{children:f.map((i,x)=>e.jsxs(ze,{children:[e.jsx(Ie,{plane:i,onAction:r}),l(i.level)&&e.jsx(Ae,{currentPlane:i,allPlanes:f,relationships:o,animated:!0})]},i.id))})},{Title:Je}=z,Me=({planes:s,metrics:o=[],loading:t=!1})=>{const{t:r}=S(["planes","common"]),n=s.length,f=s.filter(d=>d.status==="ACTIVE").length,l=s.filter(d=>d.status==="WARNING").length,i=s.filter(d=>d.status==="ERROR").length,x=o.reduce((d,c)=>d+c.instanceCount,0),m=s.reduce((d,c)=>d+c.entityHealth.healthy,0),g=s.reduce((d,c)=>d+c.entityHealth.warning,0),I=s.reduce((d,c)=>d+c.entityHealth.error,0);s.reduce((d,c)=>d+c.entityHealth.total,0);const p=[{title:r("planes:stats.totalPlanes"),value:n,icon:e.jsx(fe,{}),className:"plane-stats-primary"},{title:r("planes:stats.activePlanes"),value:f,icon:e.jsx(A,{}),className:"plane-stats-success"},{title:r("planes:stats.warningPlanes"),value:l,icon:e.jsx(T,{}),className:"plane-stats-warning"},{title:r("planes:stats.errorPlanes"),value:i,icon:e.jsx(V,{}),className:"plane-stats-error"},{title:r("planes:stats.totalInstances"),value:x,icon:e.jsx(J,{}),className:"plane-stats-purple"},{title:r("planes:stats.healthyEntities"),value:m,icon:e.jsx(A,{}),className:"plane-stats-success"},{title:r("planes:stats.warningEntities"),value:g,icon:e.jsx(T,{}),className:"plane-stats-warning"},{title:r("planes:stats.errorEntities"),value:I,icon:e.jsx(V,{}),className:"plane-stats-error"}];return e.jsx(Z,{gutter:[16,16],style:{marginBottom:32},children:p.map((d,c)=>e.jsx(K,{xs:24,sm:12,md:6,lg:3,children:e.jsx(R,{loading:t,className:d.className,children:e.jsx(he,{title:d.title,value:d.value,prefix:d.icon})})},c))})},{Title:Ze,Text:j}=z,{useToken:Be}=me,He=h.div`
  display: inline-flex;
  align-items: center;
  padding: 2px 8px;
  border-radius: 4px;
