import{u as Y,c as ue,j as e,d as b}from"./index-Ds4hQBUW.js";import{M as J,a9 as c,d as p,C as r,af as q,l as $,aR as xe,aM as he,a7 as je,r as d,T as ge,j as g,aI as fe,B as S,n as ye,o as be,S as f,aW as R,a as L,g as V,as as K,x as a,t as u,y as A,i as y,f as ve,aX as ke,ap as Te,q as Ie,u as H,v as Pe,w as Me,ai as W}from"./antd-Beg1odhe.js";import{s as Se}from"./index-Daowydkz.js";import{S as Ae}from"./SearchFilterBar-o2SMI6sp.js";import"./vendor-DJG_os-6.js";const{Option:m}=$,{TextArea:we}=q,qe=b(je)`
  margin-top: 16px;
...
`;b.div`
  ...
  border-radius: 6px;
  margin-bottom: 16px;
`;const Ve=()=>{var U,F,G,N,O;const{t:s}=Y(["models","common"]),[B,C]=d.useState(!1),[D,x]=d.useState(!1),[l,T]=d.useState(!1),[I,P]=d.useState(null),[i,Q]=d.useState(null),[Z,_]=d.useState(""),[ee,se]=d.useState("all"),[te,le]=d.useState("all"),[ie,ae]=d.useState("all"),[v]=c.useForm();d.useEffect(()=>{Se(s("models:title"))},[s]);const h=$e.models.map(t=>({...t,description:s(t.description.replace("models.","models:")),capabilities:t.capabilities.map(o=>s(o.replace("models.","models:"))),createdBy:s(t.createdBy.replace("models.","models:"))})),M={OpenAI:{color:"green",icon:e.jsx(R,{})},Anthropic:{color:"blue",icon:e.jsx(Te,{})},Google:{color:"red",icon:e.jsx(ke,{})},Azure:{color:"cyan",icon:e.jsx(ve,{})}},k={llm:{name:s("models:types.llm"),color:"blue",icon:e.jsx(R,{})},embedding:{name:s("models:types.embedding"),color:"green",icon:e.jsx(Ie,{})},image:{name:s("models:types.image"),color:"orange",icon:e.jsx(K,{})},audio:{name:s("models:types.audio"),color:"purple",icon:e.jsx(V,{})}},z=t=>{const n={active:{color:"green",text:s("models:status.active")},inactive:{color:"red",text:s("models:status.inactive")},testing:{color:"orange",text:s("models:status.testing")}}[t];return e.jsx(u,{color:n.color,children:n.text})},oe=()=>{P(null),v.resetFields(),x(!0)},re=t=>{P(t),v.setFieldsValue({name:t.name,provider:t.provider,modelType:t.modelType,version:t.version,apiEndpoint:t.apiEndpoint,maxTokens:t.maxTokens,temperature:t.temperature,description:t.description}),x(!0)},E=t=>{Q(t),T(!0)},ne=async()=>{try{const t=await v.validateFields();I?W.success(s("models:alerts.updateSuccess")):W.success(s("models:alerts.createSuccess")),x(!1),v.resetFields()}catch(t){console.error("表单验证失败:",t)}},de=()=>h.map(t=>{const o=M[t.provider],n=k[t.modelType];return e.jsx(r,{xs:24,sm:24,md:12,lg:8,xl:8,children:e.jsxs(Ue,{title:e.jsxs("div",{className:"card-title",children:[e.jsx("div",{className:"title-left",children:e.jsxs(g,{children:[o==null?void 0:o.icon,e.jsx("span",{children:t.name})]})}),e.jsx("div",{className:"title-right",children:z(t.status)})]}),onClick:()=>E(t),children:[e.jsx("div",{style:{marginBottom:12},children:e.jsxs(g,{wrap:!0,children:[e.jsx(u,{color:o==null?void 0:o.color,icon:o==null?void 0:o.icon,children:t.provider}),e.jsx(u,{color:n==null?void 0:n.color,icon:n==null?void 0:n.icon,children:n==null?void 0:n.name})]})}),e.jsx(X,{ellipsis:{rows:2},style:{marginBottom:16,minHeight:40},children:t.description}),e.jsx("div",{style:{marginBottom:12},children:e.jsxs(p,{gutter:16,children:[e.jsx(r,{span:12,children:e.jsx(f,{title:s("models:stats.usageCount"),value:t.usageCount,valueStyle:{fontSize:14}})}),e.jsx(r,{span:12,children:e.jsx(f,{title:s("models:stats.maxTokens"),value:t.maxTokens,valueStyle:{fontSize:14}})})]})}),e.jsx("div",{style:{marginBottom:12},children:e.jsxs(g,{wrap:!0,children:[t.capabilities.slice(0,3).map(j=>e.jsx(u,{size:"small",children:j},j)),t.capabilities.length>3&&e.jsxs(u,{size:"small",children:["+",t.capabilities.length-3]})]})}),e.jsxs("div",{style:{fontSize:12,color:"#666"},children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"4px"},children:[e.jsxs("span",{children:[s("models:stats.version"),":"]}),e.jsx("span",{children:t.version})]}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e.jsxs("span",{children:[s("models:stats.lastUsed"),":"]}),e.jsx("span",{children:t.lastUsed})]})]}),e.jsx("div",{className:"card-actions",children:e.jsxs(g,{children:[e.jsx(H,{title:s("models:viewDetails"),children:e.jsx(S,{type:"text",icon:e.jsx(Pe,{}),size:"small",onClick:j=>{j.stopPropagation(),E(t)}})}),e.jsx(H,{title:s("common:edit"),children:e.jsx(S,{type:"text",icon:e.jsx(Me,{}),size:"small",onClick:j=>{j.stopPropagation(),re(t)}})})]})})]})},t.id)}),ce=h.filter(t=>t.status==="active").length,me=h.reduce((t,o)=>t+o.usageCount,0),pe=h.reduce((t,o)=>t+o.temperature,0)/h.length;return e.jsxs(ze,{className:"model-management-page",children:[e.jsxs(Ee,{children:[e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8},children:[e.jsx(Be,{className:"page-title",level:2,style:{margin:0},children:e.jsxs(g,{children:[e.jsx(fe,{}),s("models:title")]})}),e.jsxs(g,{children:[e.jsx(S,{icon:e.jsx(ye,{}),children:s("common:refresh")}),e.jsx(S,{type:"primary",icon:e.jsx(be,{}),onClick:oe,children:s("models:addModel")})]})]}),e.jsx(X,{style:{marginTop:0,marginBottom:0},children:s("models:subtitle")})]}),e.jsxs(p,{gutter:16,style:{marginBottom:24},children:[e.jsx(r,{xs:24,sm:12,md:6,children:e.jsx(w,{className:"model-stats-primary",children:e.jsx(f,{title:s("models:stats.totalModels"),value:h.length,suffix:s("models:stats.unit"),prefix:e.jsx(R,{})})})}),e.jsx(r,{xs:24,sm:12,md:6,children:e.jsx(w,{className:"model-stats-success",children:e.jsx(f,{title:s("models:stats.activeModels"),value:ce,suffix:s("models:stats.unit"),prefix:e.jsx(L,{})})})}),e.jsx(r,{xs:24,sm:12,md:6,children:e.jsx(w,{className:"model-stats-warning",children:e.jsx(f,{title:s("models:stats.totalUsage"),value:me,prefix:e.jsx(V,{})})})}),e.jsx(r,{xs:24,sm:12,md:6,children:e.jsx(w,{className:"model-stats-purple",children:e.jsx(f,{title:s("models:stats.avgTemperature"),value:pe.toFixed(1),prefix:e.jsx(K,{})})})})]}),e.jsx(Ae,{searchValue:Z,onSearchChange:_,searchPlaceholder:s("models:searchPlaceholder"),filters:[{key:"provider",value:ee,onChange:se,placeholder:s("models:filterByProvider"),width:120,options:[{value:"all",label:s("models:providers.all")},...Object.entries(M).map(([t,o])=>({value:t,label:s(`models.providers.${t}`)}))]},{key:"type",value:te,onChange:le,placeholder:s("models:filterByType"),width:120,options:[{value:"all",label:s("common:all")},...Object.entries(k).map(([t,o])=>({value:t,label:o.name}))]},{key:"status",value:ie,onChange:ae,placeholder:s("models:filterByStatus"),width:100,options:[{value:"all",label:s("common:all")},{value:"active",label:s("models:status.active")},{value:"inactive",label:s("models:status.inactive")},{value:"testing",label:s("models:status.testing")}]}],onRefresh:()=>window.location.reload()}),e.jsx(p,{gutter:[16,16],children:de()}),e.jsx(De,{visible:D,editingModel:I,form:v,onOk:ne,onCancel:()=>x(!1)}),e.jsx(J,{title:i==null?void 0:i.name,open:l,onCancel:()=>T(!1),footer:null,width:1e3,style:{top:20},children:i&&e.jsxs("div",{children:[e.jsxs(a,{bordered:!0,column:2,style:{marginBottom:24},children:[e.jsx(a.Item,{label:s("models:detail.name"),span:2,children:i.name}),e.jsx(a.Item,{label:s("models:detail.provider"),children:e.jsx(u,{color:(U=M[i.provider])==null?void 0:U.color,icon:(F=M[i.provider])==null?void 0:F.icon,children:i.provider})}),e.jsx(a.Item,{label:s("models:detail.type"),children:e.jsx(u,{color:(G=k[i.modelType])==null?void 0:G.color,icon:(N=k[i.modelType])==null?void 0:N.icon,children:(O=k[i.modelType])==null?void 0:O.name})}),e.jsx(a.Item,{label:s("models:detail.version"),children:i.version}),e.jsx(a.Item,{label:s("models:detail.status"),children:z(i.status)}),e.jsx(a.Item,{label:s("models:detail.apiEndpoint"),span:2,children:e.jsx(Ce,{code:!0,children:i.apiEndpoint})}),e.jsxs(a.Item,{label:s("models:detail.usageCount"),children:[i.usageCount,s("models:stats.requestUnit")]}),e.jsx(a.Item,{label:s("models:detail.lastUsed"),children:i.lastUsed}),e.jsx(a.Item,{label:s("models:detail.createdBy"),children:i.createdBy}),e.jsx(a.Item,{label:s("models:detail.createdAt"),children:i.createdAt}),e.jsx(a.Item,{label:s("models:detail.description"),span:2,children:i.description})]}),e.jsxs(A,{defaultActiveKey:"parameters",children:[e.jsx(A.TabPane,{tab:s("models:detail.parameters"),children:e.jsxs(p,{gutter:16,children:[e.jsx(r,{span:12,children:e.jsx(y,{title:s("models:detail.parameters"),size:"small",children:e.jsxs(a,{column:1,size:"small",children:[e.jsx(a.Item,{label:s("models:detail.maxTokens"),children:i.maxTokens}),e.jsx(a.Item,{label:s("models:detail.temperature"),children:i.temperature}),e.jsx(a.Item,{label:s("models:detail.topP"),children:i.topP}),e.jsx(a.Item,{label:s("models:detail.frequencyPenalty"),children:i.frequencyPenalty}),e.jsx(a.Item,{label:s("models:detail.presencePenalty"),children:i.presencePenalty})]})})}),e.jsx(r,{span:12,children:e.jsx(y,{title:s("models:detail.limits"),size:"small",children:e.jsxs(a,{column:1,size:"small",children:[e.jsx(a.Item,{label:s("models:detail.requestsPerMinute"),children:i.limits.requestsPerMinute}),e.jsx(a.Item,{label:s("models:detail.tokensPerMinute"),children:i.limits.tokensPerMinute}),e.jsx(a.Item,{label:s("models:detail.dailyLimit"),children:i.limits.dailyLimit})]})})})]})},"parameters"),e.jsx(A.TabPane,{tab:s("models:detail.capabilities"),children:e.jsx(p,{gutter:16,children:i.capabilities.map(t=>e.jsx(r,{xs:24,sm:12,lg:8,children:e.jsx(y,{size:"small",style:{marginBottom:16},children:e.jsxs("div",{style:{textAlign:"center"},children:[e.jsx(L,{style:{color:"#52c41a",fontSize:24,marginBottom:8}}),e.jsx("div",{children:t})]})})},t))})},"capabilities"),e.jsx(A.TabPane,{tab:s("models:detail.pricing"),children:e.jsx(y,{title:s("models:detail.pricingDetails"),size:"small",children:e.jsxs(a,{column:2,size:"small",children:[e.jsxs(a.Item,{label:s("models:detail.inputTokenPrice"),children:["$",i.pricing.inputTokens," / 1K tokens"]}),e.jsxs(a.Item,{label:s("models:detail.outputTokenPrice"),children:["$",i.pricing.outputTokens," / 1K tokens"]}),e.jsx(a.Item,{label:s("models:detail.currency"),children:i.pricing.currency})]})})},"pricing")]})]})})]})};export{Ve as default};
