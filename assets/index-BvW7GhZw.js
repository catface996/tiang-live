import{u as E,c as O,j as e,d as h}from"./index-CCrQ40Eo.js";import{M as ee,aa as x,d as v,C as n,ag as se,l as P,aO as me,a8 as ue,x as d,t as f,j as u,aZ as te,T as ae,a_ as V,B as C,a$ as he,i as H,r as m,Z as z,n as xe,o as ge,S as D,a as je,aq as be,u as G,v as ye,w as ve,aj as q,k as $e,al as ke,am as we,g as De,ax as Ce}from"./antd-DB_1XVWl.js";import{s as Ie}from"./index-Daowydkz.js";import{S as Se}from"./SearchFilterBar-hGzW7t0l.js";import"./vendor-DJG_os-6.js";const{Option:p}=P,{TextArea:Q}=se,Te=h(ue)`
  margin-top: 16px;
...
`;h.div`
  ...
  border-radius: 6px;
  margin-bottom: 16px;
`;const Le=()=>{const{t:s}=E(["prompts","common"]),{currentTheme:r}=O(t=>t.theme),[I,S]=m.useState(!1),[j,a]=m.useState(!1),[$,i]=m.useState(!1),[b,l]=m.useState(null),[F,T]=m.useState(null),[R,M]=m.useState(""),[c,k]=m.useState("all"),[L,N]=m.useState("all"),[A,re]=m.useState("all"),[w]=x.useForm();m.useEffect(()=>{Ie(s("prompts:title"))},[s]);const g=[{id:"1",name:"代码审查助手",category:"开发工具",description:"帮助开发者进行代码审查，识别潜在问题和改进建议",content:`你是一个专业的代码审查专家。请仔细审查以下代码，并提供详细的反馈：
