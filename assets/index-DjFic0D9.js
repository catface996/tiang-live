import{u as pe,c as me,j as e,d as h}from"./index-DmkKiKNT.js";import{r as c,a6 as p,T as ue,k as d,V as w,B as f,o as xe,p as he,d as x,C as r,S as j,a as ge,ax as C,al as fe,M as N,ac as H,m as P,ay as je,P as ye,y as i,u as n,az as q,j as y,aA as ve,v as U,w as be,x as Pe,af as T,l as Ie,ag as Se,ah as we,g as Ce,av as Te}from"./antd-CbyKqlos.js";import{s as Re}from"./index-Daowydkz.js";import{S as ke}from"./SearchFilterBar-4TmCfIdQ.js";import"./vendor-DJG_os-6.js";const{Title:Me,Paragraph:V,Text:D}=ue,{Option:o}=P,{TextArea:E}=H,ze=h.div`
  padding: 24px;
`,_e=h.div`
  margin-bottom: 24px;
`,b=h(y)`
...
`;const Fe=h.div`
  ...
  max-height: 200px;
  overflow-y: auto;
`,He=()=>{var F,$,B;const{t:s}=pe(["prompts","common"]),{currentTheme:K}=me(t=>t.theme),O=K==="dark"?"#ffffff":"#1890ff",[Be,Ne]=c.useState(!1),[L,v]=c.useState(!1),[J,R]=c.useState(!1),[k,M]=c.useState(null),[a,Y]=c.useState(null),[G,Q]=c.useState(""),[W,X]=c.useState("all"),[Z,ee]=c.useState("all"),[se,te]=c.useState("all"),[g]=p.useForm();c.useEffect(()=>{Re(s("prompts:title"))},[s]);const m=[{id:"1",name:"代码审查助手",category:"开发工具",description:"帮助开发者进行代码审查，识别潜在问题和改进建议",content:`你是一个专业的代码审查专家。请仔细审查以下代码，并提供详细的反馈：
