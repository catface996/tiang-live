import{a as c,j as e}from"./react-BkaC_jdz.js";import{u as pe,aC as p,c as me,S as d,n as w,B as f,ai as ue,aa as he,U as h,V as l,W as j,K as xe,bn as C,p as ge,aF as N,az as H,a1 as P,bg as fe,ap as je,ax as i,a3 as n,bo as q,_ as y,bp as ye,d as x,T as U,a8 as ve,a9 as be,ah as T,a0 as Pe,o as Ie,a as Se,Y as we,bk as Ce}from"./react-dom-ZHUlsYA_.js";import{u as Te}from"./index-Bna1uyxb.js";import{s as Re}from"./index-Daowydkz.js";import{S as ke}from"./SearchFilterBar-Dq5sQrlY.js";import"./vendor-CsGdsTBW.js";import"./dayjs-Bzorz0fL.js";import"./media-BbQ0wNgX.js";import"./lodash-BORto0-T.js";import"./redux-CiqK6azd.js";import"./echarts-core-7X-L1hka.js";import"./antd-icons-CI4I6I7B.js";import"./emotion-BhZTwsuK.js";import"./mermaid-DnXdFSui.js";import"./d3-ByniJY_B.js";import"./i18n-CMVetavo.js";const{Title:Me,Paragraph:V,Text:D}=me,{Option:o}=P,{TextArea:E}=H,_e=x.div`
  padding: 24px;
`,ze=x.div`
  margin-bottom: 24px;
`,b=x(y)`
...
`;const Ae=x.div`
  ...
  max-height: 200px;
  overflow-y: auto;
`,et=()=>{var A,$,B;const{t}=pe(["prompts","common"]),{currentTheme:K}=Te(s=>s.theme),O=K==="dark"?"#ffffff":"#1890ff",[Be,Ne]=c.useState(!1),[L,v]=c.useState(!1),[Y,R]=c.useState(!1),[k,M]=c.useState(null),[a,J]=c.useState(null),[W,G]=c.useState(""),[Q,X]=c.useState("all"),[Z,ee]=c.useState("all"),[te,se]=c.useState("all"),[g]=p.useForm();c.useEffect(()=>{Re(t("prompts:title"))},[t]);const m=[{id:"1",name:"代码审查助手",category:"开发工具",description:"帮助开发者进行代码审查，识别潜在问题和改进建议",content:`你是一个专业的代码审查专家。请仔细审查以下代码，并提供详细的反馈：
