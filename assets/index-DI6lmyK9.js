import{a as l,R as me,j as e}from"./react-D_ZWy-Ho.js";import{_ as F,y as xe,d as y,aC as x,u as he,c as fe,S as d,k as E,B as q,ai as je,aa as ge,U as f,V as r,W as w,aD as qe,aE as U,ab as ye,aF as O,ax as u,a3 as A,r as B,az as k,a1 as P,an as H,X as Q,aG as W,a8 as J,a7 as ve,aH as be,aI as Se,T as X,a9 as Ce,ah as I}from"./react-dom-GpeNoQsX.js";import{s as we}from"./index-Daowydkz.js";import{S as Me}from"./SearchFilterBar-Lz3VU8LA.js";import{m as Y}from"./mermaid-AggIEIwl.js";import{L as Ae}from"./index-uv9RzyYU.js";import"./vendor-VHja5XRA.js";import"./cytoscape-DXzeTOL3.js";import"./media-BPG7piku.js";import"./lodash-D08E6HgQ.js";import"./redux-CiqK6azd.js";import"./echarts-core-CW0Gv0IT.js";import"./antd-icons-CI4I6I7B.js";import"./dayjs-CrhenB4N.js";import"./emotion-BhZTwsuK.js";import"./d3-Dbz_rnoS.js";import"./i18n-CMVetavo.js";const Re=y.div`
  .mermaid {
    display: flex;
...
`,_=({chart:n,title:j,loading:v=!1})=>{const c=l.useRef(null),[b,o]=me.useState(!1);return l.useEffect(()=>{Y.initialize({startOnLoad:!1,theme:"default",securityLevel:"loose",fontFamily:"Arial, sans-serif",fontSize:14,sequence:{diagramMarginX:50,diagramMarginY:10,actorMargin:50,width:150,height:65,boxMargin:10,boxTextMargin:5,noteMargin:10,messageMargin:35,mirrorActors:!0,bottomMarginAdj:1,useMaxWidth:!0,rightAngles:!1,showSequenceNumbers:!1}})},[]),l.useEffect(()=>{const h=async()=>{if(!n||!n.trim()){console.log("时序图: 没有图表内容"),o(!1);return}if(!c.current){console.log("时序图: DOM元素未准备好"),o(!1);return}console.log("时序图: 开始渲染",n.substring(0,50)+"..."),o(!0);try{c.current.innerHTML="";const p=`sequence-diagram-${Date.now()}-${Math.random().toString(36).substr(2,9)}`;console.log("时序图: 调用mermaid.render");const{svg:S}=await Y.render(p,n);console.log("时序图: 渲染成功"),c.current&&(c.current.innerHTML=S),o(!1)}catch(p){console.error("时序图渲染错误:",p),c.current&&(c.current.innerHTML=`
            <div style="text-align: center; color: #ff4d4f; padding: 20px;">
              ...
              <details style="margin-top: 10px; text-align: left;">
                ...
                <pre style="font-size: 10px; color: #666; margin-top: 5px;">${p}</pre>
              </details>
            </div>
          `),o(!1)}},m=setTimeout(()=>{h()},100);return()=>clearTimeout(m)},[n]),v||b?e.jsx(F,{title:j,children:e.jsx(Ie,{children:e.jsx(xe,{size:"large",tip:"正在渲染时序图..."})})}):e.jsx(F,{title:j,children:e.jsx(Re,{children:e.jsx("div",{ref:c,className:"mermaid"})})})},De=[{id:"1",name:"用户登录认证流程",description:"用户通过前端登录，后端验证身份并返回token的完整时序流程",type:"authentication",status:"active",participants:["用户","前端应用","认证服务","数据库"],steps:8,duration:"2000-5000",createdBy:"系统架构师",createdAt:"2024-06-10",lastModified:"2024-06-14",mermaidChart:`sequenceDiagram
    participant U as 用户
    ...
    end`}],Pe={sequences:De},K=(n,j)=>{if(!n)return"";const v=n.match(/^(\d+)-(\d+)$/);if(!v)return n;const[,c,b]=v,o=parseInt(c),h=parseInt(b);if(o>=1e3){const m=o/1e3,p=h/1e3,S=m%1===0?m.toString():m.toFixed(1),R=p%1===0?p.toString():p.toFixed(1);return`${S}-${R} ${j("sequences.units.seconds")}`}else return`${c}-${b} ${j("sequences.units.milliseconds")}`},{Title:Fe,Paragraph:Te,Text:ss}=fe,{Option:i}=P,{TextArea:Z}=k,Ue=y.div`
  padding: 24px;
`,Oe=y.div`
  margin-bottom: 24px;
`,Be=y(Z)`
