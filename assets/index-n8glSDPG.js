import{u as S,j as e,d as h,c as U,b as ee,e as se,s as F,f as te,h as M,i as ne,k as ae,l as re}from"./index-CLn_jbkO.js";import{u as L,v as b,a as z,$ as T,b5 as K,aJ as ie,T as A,aj as le,k as D,B as P,w as oe,x as de,p as q,N as ce,j as R,b6 as Q,b7 as pe,O as xe,ak as _,e as fe,ab as X,d as Z,C as V,S as he,K as me,a1 as ge,r as ue,af as B,o as ye}from"./antd-CtXjdSWW.js";import{s as je}from"./index-Daowydkz.js";import{g as be,a as w,b as ve,p as H}from"./PlaneCreateEdit-CKzFOAOb.js";import{P as ns}from"./PlaneCreateEdit-CKzFOAOb.js";import"./vendor-DJG_os-6.js";const J=h.div`
  display: flex;
  align-items: center;
...
`,$e=h.div`
  width: 100%;
  margin-top: 8px;
`,ke=({entityHealth:s,showProgress:o=!1,size:t="default"})=>{const{t:r}=S(["entities","common"]),{healthy:n,warning:f,error:l,total:i}=s;if(i===0)return e.jsx(J,{$size:t,children:e.jsx(L,{color:"default",children:r("planes:card.entityStats.noEntities")})});const x=n/i*100,m=f/i*100,g=l/i*100;return e.jsxs("div",{children:[e.jsxs(J,{$size:t,children:[e.jsx(b,{title:`${r("planes:card.entityStats.healthyTooltip")}: ${n} (${x.toFixed(1)}%)`,children:e.jsxs(W,{$size:t,children:[e.jsx(z,{style:{color:"#52c41a"}}),e.jsx("span",{style:{color:"#52c41a",fontWeight:500},children:n})]})}),e.jsx(b,{title:`${r("planes:card.entityStats.warningTooltip")}: ${f} (${m.toFixed(1)}%)`,children:e.jsxs(W,{$size:t,children:[e.jsx(T,{style:{color:"#faad14"}}),e.jsx("span",{style:{color:"#faad14",fontWeight:500},children:f})]})}),e.jsx(b,{title:`${r("planes:card.entityStats.errorTooltip")}: ${l} (${g.toFixed(1)}%)`,children:e.jsxs(W,{$size:t,children:[e.jsx(K,{style:{color:"#ff4d4f"}}),e.jsx("span",{style:{color:"#ff4d4f",fontWeight:500},children:l})]})}),e.jsxs("span",{style:{color:"#8c8c8c",fontSize:t==="small"?"11px":"12px"},children:["/ ",i]})]}),o&&e.jsxs($e,{children:[e.jsx(ie,{percent:100,success:{percent:x},strokeColor:{"0%":"#ff4d4f",[`${g}%`]:"#ff4d4f",[`${g+m}%`]:"#faad14","100%":"#52c41a"},showInfo:!1,size:"small"}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",fontSize:"11px",color:"#8c8c8c",marginTop:"4px"},children:[e.jsxs("span",{children:[r("planes:card.entityStats.error")," ",g.toFixed(1),"%"]}),e.jsxs("span",{children:[r("planes:card.entityStats.warning")," ",m.toFixed(1),"%"]}),e.jsxs("span",{children:[r("planes:card.entityStats.healthy")," ",x.toFixed(1),"%"]})]})]})]})},{Text:$,Paragraph:we}=A,De=h(R)`
  margin-bottom: 16px;
...
`,Y=s=>{var o;return((o=s.properties)==null?void 0:o.strength)||"medium"},Le=s=>{var o;return((o=s.properties)==null?void 0:o.description)||"支撑关系"},ze=({currentPlane:s,allPlanes:o,relationships:t,animated:r=!0})=>{const n=t.filter(l=>s.dependencies.includes(l.sourceId)&&l.targetId===s.id);if(n.length===0)return null;const f=n.sort((l,i)=>{const x={critical:4,strong:3,medium:2,weak:1},m=x[Y(l)]||0;return(x[Y(i)]||0)-m});return e.jsxs(Pe,{$animated:r,children:[e.jsx(Te,{$animated:r,children:n.length>1?e.jsx(b,{title:`${s.displayName} 依赖 ${n.length} 个平面`,children:e.jsx(Q,{className:"arrow-icon"})}):e.jsx(pe,{className:"arrow-icon"})}),e.jsx(Re,{children:f.map(l=>{const i=o.find(g=>g.id===l.sourceId),x=Y(l),m=Le(l);return e.jsx(b,{title:`${i==null?void 0:i.displayName} → ${s.displayName}: ${m}`,children:e.jsx(Ee,{$planeId:l.sourceId,$strength:x,children:(i==null?void 0:i.displayName)||l.sourceId})},l.id)})})]})},O=h.div`
...
`,Fe=({planes:s,relationships:o,loading:t=!1,onPlaneAction:r})=>{const{t:n}=S(["planes","common"]),f=[...s].sort((i,x)=>x.level-i.level),l=i=>f.some(x=>x.level===i-1);return t?e.jsx(O,{children:e.jsxs("div",{className:"loading-container",children:[e.jsx(xe,{size:"large"}),e.jsx("div",{className:"loading-text",children:n("planes:loading.topology")})]})}):s.length===0?e.jsx(O,{children:e.jsx(_,{description:n("planes:loading.noPlaneData"),image:_.PRESENTED_IMAGE_SIMPLE})}):e.jsx(O,{children:f.map((i,x)=>e.jsxs(Ae,{children:[e.jsx(Ie,{plane:i,onAction:r}),l(i.level)&&e.jsx(ze,{currentPlane:i,allPlanes:f,relationships:o,animated:!0})]},i.id))})},{Title:Xe}=A,Me=({planes:s,metrics:o=[],loading:t=!1})=>{const{t:r}=S(["planes","common"]),n=s.length,f=s.filter(d=>d.status==="ACTIVE").length,l=s.filter(d=>d.status==="WARNING").length,i=s.filter(d=>d.status==="ERROR").length,x=o.reduce((d,c)=>d+c.instanceCount,0),m=s.reduce((d,c)=>d+c.entityHealth.healthy,0),g=s.reduce((d,c)=>d+c.entityHealth.warning,0),I=s.reduce((d,c)=>d+c.entityHealth.error,0);s.reduce((d,c)=>d+c.entityHealth.total,0);const p=[{title:r("planes:stats.totalPlanes"),value:n,icon:e.jsx(fe,{}),color:"#1890ff"},{title:r("planes:stats.activePlanes"),value:f,icon:e.jsx(z,{}),color:"#52c41a"},{title:r("planes:stats.warningPlanes"),value:l,icon:e.jsx(T,{}),color:"#faad14"},{title:r("planes:stats.errorPlanes"),value:i,icon:e.jsx(K,{}),color:"#ff4d4f"},{title:r("planes:stats.totalInstances"),value:x,icon:e.jsx(X,{}),color:"#722ed1"},{title:r("planes:stats.healthyEntities"),value:m,icon:e.jsx(z,{}),color:"#52c41a"},{title:r("planes:stats.warningEntities"),value:g,icon:e.jsx(T,{}),color:"#faad14"},{title:r("planes:stats.errorEntities"),value:I,icon:e.jsx(K,{}),color:"#ff4d4f"}];return e.jsx(Z,{gutter:[16,16],style:{marginBottom:32},children:p.map((d,c)=>e.jsx(V,{xs:24,sm:12,md:6,lg:3,children:e.jsx(R,{loading:t,children:e.jsx(he,{title:d.title,value:d.value,prefix:d.icon,valueStyle:{color:d.color}})})},c))})},{Title:Ze,Text:j}=A,{useToken:Be}=me,He=h.div`
  display: inline-flex;
  align-items: center;
  padding: 2px 8px;
  border-radius: 4px;
  background: ${s=>s.$isDark?`${w(s.$planeId)}20`:ve(s.$planeId)};
  border: 1px solid ${s=>w(s.$planeId)};
  margin-right: 8px;
