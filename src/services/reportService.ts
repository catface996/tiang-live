    ...
    sections: [
      {
        ...
        title: '执行摘要',
        content:
          '系统整体健康状况良好，93.3%的服务运行正常。在监控的45个核心服务中，42个服务状态健康，2个服务存在性能警告，1个服务需要紧急处理。',
        type: 'summary',
        keyMetrics: {
          systemUptime: '99.2%',
      ...
      },
      {
        ...
        analysis: {
          ...
          rootCauses: ['通知服务消息队列积压', '支付服务第三方依赖不稳定', '高峰期资源竞争加剧', '缓存策略需要优化']
        }
      },
      {
      ...
      },
      {
        ...
        title: '依赖关系概览',
        content:
          '系统共包含45个核心服务，相互之间存在128个依赖关系。整体架构复杂度适中，但存在3个循环依赖需要重点关注。',
        type: 'summary',
        metrics: {
          totalServices: 45,
      ...
      },
      {
        ...
        issues: [
          {
            cycle: '订单服务 → 支付服务 → 通知服务 → 订单服务',
            severity: 'high',
            impact: '影响订单和支付流程的独立部署'
          },
        ...
        bottlenecks: [
          {
            ...
            issue: '高并发下队列积压',
            impact: '响应时间增加300%',
            solution: '增加消息处理线程，优化批处理逻辑'
          },
          {
            component: '数据库连接池',
            issue: '连接池耗尽',
            impact: '服务不可用',
            solution: '增加连接池大小，优化连接复用'
          },
          {
            component: 'Redis缓存',
            issue: '缓存命中率低',
            impact: '数据库压力增大',
            solution: '优化缓存策略，增加缓存预热'
          },
    ...
    sections: [
      {
        ...
        title: '执行摘要',
        content:
          '电商业务场景整体运行稳定，87.5%的核心业务流程表现良好。主要问题集中在支付结算流程的响应延迟和库存同步的数据一致性问题。',
        type: 'summary',
        keyMetrics: {
          dailyOrders: '45,680',
          conversionRate: '3.2%',
    ...
    sections: [
      {
        titleKey: 'executiveSummary',
        title: '执行摘要',
        content: '业务系统架构整体健康，85.7%的系统模块运行良好。',
        type: 'summary'
      },
      {
        titleKey: 'serviceStatusAnalysis',
        title: '服务状态详细分析',
        content: '各业务系统的详细运行状态分析。',
        type: 'analysis'
      },
      {
        titleKey: 'performanceTrendAnalysis',
        title: '性能指标趋势分析',
        content: '业务系统性能指标趋势分析。',
        type: 'trend'
      },
    ...
    sections: [
      {
        titleKey: 'executiveSummary',
        title: '执行摘要',
        content: '中间件服务整体运行稳定，88.2%的中间件组件表现良好。',
        type: 'summary'
      },
      {
        titleKey: 'serviceStatusAnalysis',
        title: '服务状态详细分析',
        content: '各中间件服务的详细运行状态分析。',
        type: 'analysis'
      },
      {
        titleKey: 'performanceTrendAnalysis',
    ...
    sections: [
      {
        titleKey: 'executiveSummary',
        title: '执行摘要',
        content: '基础设施整体运行稳定，91.5%的基础组件表现优良。',
        type: 'summary'
      },
      {
        titleKey: 'serviceStatusAnalysis',
        title: '服务状态详细分析',
        content: '各基础设施组件的详细运行状态分析。',
        type: 'analysis'
      },
      {
        titleKey: 'performanceTrendAnalysis',
        title: '性能指标趋势分析',
        content: '基础设施性能指标趋势分析。',
        type: 'trend'
      },
