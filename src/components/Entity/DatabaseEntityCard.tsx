...
const DatabaseEntityCard: React.FC<DatabaseEntityCardProps> = ({ entity, entityTypes, onClick, onEdit }) => {
  return (
    <BaseEntityCard
      entity={entity}
      onClick={onClick}
    ...
    >
      ...
      <Space direction="vertical" style={{ width: '100%' }}>
        ...
        <div style={{ marginTop: 12, display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 8 }}>
          <Statistic title="连接数" value={entity.metrics?.connectionCount} valueStyle={{ fontSize: '14px' }} />
          <Statistic
            title="存储大小"
