...
interface BusinessLinkEntityCardProps {
...
const BusinessLinkEntityCard: React.FC<BusinessLinkEntityCardProps> = ({ entity, entityTypes, onClick, onEdit }) => {
  return (
...
export default BusinessLinkEntityCard;
