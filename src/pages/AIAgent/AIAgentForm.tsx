...
const AIAgentForm: React.FC = () => {
  ...
  const loadAgentData = async () => {
    ...
    try {
      ...
      setSelectedModel(`${agentData.model.provider}-${agentData.model.modelName}`);
      setSelectedMcpServers(agentData.mcpServers);
      setCustomPrompt(agentData.prompts.system);
      setPromptVariables(agentData.prompts.variables);
    } catch (error) {
