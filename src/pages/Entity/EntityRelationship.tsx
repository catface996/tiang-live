...
import { Typography, Card, Tabs, Space, Button, Row, Col, Statistic, Badge, Tag } from 'antd';
import {
  NodeIndexOutlined,
  ShareAltOutlined,
  PlusOutlined,
    ...
    <TabContent>
      ...
      <Row gutter={16} style={{ marginBottom: 24 }}>
        <Col xs={24} sm={12} md={6}>
          <StatsCard>
            <Statistic title="实体类型" value={0} suffix="个" valueStyle={{ color: '#1890ff' }} />
          </StatsCard>
        </Col>
        <Col xs={24} sm={12} md={6}>
          <StatsCard>
            <Statistic title="实体实例" value={0} suffix="个" valueStyle={{ color: '#52c41a' }} />
          </StatsCard>
        </Col>
        <Col xs={24} sm={12} md={6}>
          <StatsCard>
            <Statistic title="活跃实体" value={0} suffix="个" valueStyle={{ color: '#faad14' }} />
          </StatsCard>
        </Col>
        <Col xs={24} sm={12} md={6}>
          <StatsCard>
            <Statistic title="异常实体" value={0} suffix="个" valueStyle={{ color: '#f5222d' }} />
          </StatsCard>
        </Col>
      </Row>
      ...
      <Row gutter={16}>
        <Col xs={24} md={12} lg={8}>
          ...
          >
            <Paragraph>定义和管理不同类型的实体，包括属性定义、约束规则和生命周期配置。</Paragraph>
            <div>
        ...
        <Col xs={24} md={12} lg={8}>
          ...
          >
            <Paragraph>创建、编辑和管理具体的实体实例，支持批量操作和状态管理。</Paragraph>
            <div>
        ...
        <Col xs={24} md={12} lg={8}>
          ...
          >
            <Paragraph>强大的搜索和过滤功能，支持多维度查询和高级筛选条件。</Paragraph>
            <div>
  ...
  const renderRelationshipGraph = () => (
    <TabContent>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 24 }}>
        ...
        <Space>
          <Button icon={<ExportOutlined />}>导出图谱</Button>
          <Button icon={<SettingOutlined />}>图谱设置</Button>
          <Button icon={<ReloadOutlined />}>刷新图谱</Button>
        </Space>
      </div>
      ...
      <Row gutter={16} style={{ marginBottom: 24 }}>
        <Col xs={24} sm={12} md={6}>
          <StatsCard>
            <Statistic title="关系总数" value={25} suffix="条" valueStyle={{ color: '#1890ff' }} />
          </StatsCard>
        </Col>
        <Col xs={24} sm={12} md={6}>
          <StatsCard>
            <Statistic title="关系类型" value={5} suffix="种" valueStyle={{ color: '#52c41a' }} />
          </StatsCard>
        </Col>
        <Col xs={24} sm={12} md={6}>
          <StatsCard>
            <Statistic title="图谱节点" value={21} suffix="个" valueStyle={{ color: '#faad14' }} />
          </StatsCard>
        </Col>
        <Col xs={24} sm={12} md={6}>
          <StatsCard>
            <Statistic title="支付系统" value={5} suffix="个" valueStyle={{ color: '#722ed1' }} />
          </StatsCard>
        </Col>
      </Row>
      ...
      <Row gutter={16} style={{ marginTop: 24 }}>
        <Col xs={24} md={12} lg={8}>
          ...
          >
            <Paragraph>展示从业务场景、业务链路、业务系统、中间件到基础设施的5层架构关系。</Paragraph>
            <div>
              <Tag color="blue">业务场景</Tag>
              <Tag color="green">业务链路</Tag>
              <Tag color="orange">业务系统</Tag>
              <Tag color="purple">中间件</Tag>
              <Tag style={{ color: '#5F9EA0', borderColor: '#5F9EA0' }}>基础设施</Tag>
            </div>
          </FeatureCard>
        </Col>
        <Col xs={24} md={12} lg={8}>
          ...
          >
            <Paragraph>展示完整的支付结算生态系统，包含支付网关、钱包、风控、清结算等核心系统。</Paragraph>
            <div>
        ...
        <Col xs={24} md={12} lg={8}>
          ...
          >
            <Paragraph>支持包含、依赖、使用、运行、存储、日志等6种关系类型的可视化展示。</Paragraph>
            <div>
