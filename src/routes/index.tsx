  ...
  return (
    <Routes>
      <Route path="/" element={<MainLayout />}>
        ...
        />
        <Route
          path="task-management/task-collections/run/:runId"
          element={
            <Suspense fallback={<PageLoading />}>
        ...
        />
        <Route
          path="task-management/task-collections/history/:taskId"
          element={
            <Suspense fallback={<PageLoading />}>
        ...
        />
        <Route
          path="task-management/task-collections/history"
          element={
            <Suspense fallback={<PageLoading />}>
              <TaskExecutionHistory />
            </Suspense>
        ...
        />
        <Route
          path="task-management/inspection-tasks"
          element={
            <Suspense fallback={<PageLoading />}>
              <InspectionTasks />
            </Suspense>
        ...
        />
        <Route
          path="task-management/hook-tasks"
          element={
            <Suspense fallback={<PageLoading />}>
              <HookTasks />
            </Suspense>
        ...
        />
        <Route
          path="system-settings/model-management"
          element={
            <Suspense fallback={<PageLoading />}>
              <ModelManagement />
            </Suspense>
        ...
        />
        <Route
          path="system-settings/prompt-templates"
          element={
            <Suspense fallback={<PageLoading />}>
              <PromptTemplates />
            </Suspense>
        ...
        />
        <Route
          path="system-settings/tag-management"
          element={
            <Suspense fallback={<PageLoading />}>
              <TagManagement />
            </Suspense>
        ...
        />
        <Route
          path="system-settings/entity-scan"
          element={
            <Suspense fallback={<PageLoading />}>
              <EntityScan />
            </Suspense>
        ...
        />
        <Route
          path="test-tools/entity-topology/:id"
          element={
            <Suspense fallback={<PageLoading />}>
              <EntityTopologyDetail />
            </Suspense>
          }
        />
      </Route>
